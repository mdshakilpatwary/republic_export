  ...
  <section class="section profile">
    <div class="row">
        <div class="offset-md-1 offset-lg-1 col-lg-10 col-12 col-md-10">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Home Client Logo Element</h5>
                ...
                @if(PageElement::where('type','=',2)->first())
                    ...
                    @endphp
                    <form method="POST" action="{{route('home.client.element.update',$elements->type)}}" enctype="multipart/form-data" class="needs-validation" novalidate="">
                    @csrf
                      <div class="row mb-3">
                                ...
                                <div class="col-md-12 col-xl-12 col-lg-12 col-12 col-sm-12">
                                    ...
                                    @foreach ($contentArray['contentTitle'] as $key => $title)
                                        <tr class="row_one">
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <label for="elementText">Alt Text</label>
                  ...
                  <!-- insert Form Elements -->
                        <form method="POST" action="{{route('home.client.element.store')}}" enctype="multipart/form-data" class="needs-validation" novalidate="">
                        @csrf
                            <div class="row mb-3">
